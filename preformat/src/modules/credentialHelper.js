...
// fs.promises — access() para detectar carpetas sin leer contenido; writeFile en cifrado.
const fs   = require('fs').promises;
// path — join de rutasDeteccion con variables de entorno.
...
// forge — namespace node-forge (random, pkcs5.pbkdf2, cipher AES-CBC); null si no instalado.
let forge;
try {

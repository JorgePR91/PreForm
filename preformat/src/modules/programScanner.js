...
//
// RUTAS DEL REGISTRO (claves bajo HKEY_LOCAL_MACHINE):
//   - HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall
//   - HKLM\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall
// NOTA DE IMPLEMENTACIÓN: leerClavesRegistro() usa hive Registry.HKLM para ambas rutas.
//   HKCU (programas por usuario) no está leído en el código actual; añadirlo requeriría
//   otra llamada con hive Registry.HKCU y la misma ruta relativa Uninstall.
// =============================================================

const path = require('path');
// fs.promises — escritura de exportaciones JSON/CSV y escribirConLimpieza.
...
// Registry — clase del paquete winreg; undefined si require falla (modo demo).
let Registry;
try {

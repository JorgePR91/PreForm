...
// fs (síncrono) — createWriteStream para encadenar con PDFDocument.pipe.
const fs   = require('fs');       // Versión síncrona — necesaria para streams de PDFKit
// path — import presente; ninguna función de este archivo lo usa actualmente (se puede eliminar si se desea).
